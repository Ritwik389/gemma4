...
# ==========================================
# Setup device acceleration (use MPS on Apple Silicon if available, otherwise CUDA or CPU)
...
if __name__ == "__main__":
    ...
    if video_created:
        ...
        messages = [
            {
                'role': 'user',
                'content': [
                    # Pass the newly stitched video path directly to the processor
        ...
        print("\nSkipping LLM analysis because no anomalous video was stitched.")